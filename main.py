...
player_left = Player(resource_path("player_pong.png"), 30, 200, 10, 150, 12)
player_right = Player(resource_path("player_pong.png"), win_width - 30, 200, 10, 150, 12)
ball = GameSprite(resource_path("ball_pong.png"), win_width / 2, win_height / 2, 32, 32, 0)
